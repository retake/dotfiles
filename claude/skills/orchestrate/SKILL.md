...
1. `~/dev-log/retrospectives/_index.md` をReadツールで読む（存在しない場合はスキップ）
...
【過去の教訓】
（~/dev-log/retrospectives/_index.mdから読んだ内容をここに転記する）
...
【過去の教訓】
（~/dev-log/retrospectives/_index.mdから読んだ内容を転記）
